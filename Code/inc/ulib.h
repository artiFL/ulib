...
} FunctionalStateoONOFF; 		//functional status

FunctionalStateoONOFF STAT;		//functional status
FunctionalStatelED LED;
////////////////////////////////////////////////////////

extern volatile u32 clock;
...
//////////////////////////////////////////////////////
#define SIGNATURE_TO_CONNECTION 			 0x5E		//'^'
#define SIGNATURE_END_SEARCH				 0X5F		//'_'
#define SIGNATURE_CONFIRM_CONNECTION		 0x7E		//'~'

#define SIGNATURE_PORT_CLOSE  				 0x7C		//'|'

#define SIGMATURE_START_RECIVE_ARRAY_STRING	 0x7B		//'{'
#define SIGNATURE_END_RECIVE_ARRAY_STRING	 0x7D 		//'}'

#define SIGNATURE_START_RECIVE_ARRAY_BYTE	 0x5B		//'['
#define SIGNATURE_END_RECIVE_ARRAY_BYTE		 0x5D		//']'

#define SIGNATURE_START_SEND_ARRAY_BYTE 	 0x3C		//'<'
#define SIGNATURE_END_SEND_ARRAY_BYTE		 0x3E		//'>'
...
u8 flag_get_byte	;
u8 flag_get_array_byte		;
u8 flag_get_array_string	;


u8 bufferRessive[124];
volatile char str[260];

/*____________________________________________________*/
void indication_led_init (u8 STAT, u8 LED);
void blink (u32 timeDelay, u8 ONOFF, u8 LED);
...
// A0 pin macros
#define A0_L() GPIOC -> BSRR |= GPIO_BSRR_BR_8
#define A0_H() GPIOC -> BSRR |= GPIO_BSRR_BS_8
